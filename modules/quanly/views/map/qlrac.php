...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const MAP_ZOOM = 11;
    const layerConfig = [
        { id: 'wmsDiemthugom1Layer', wmsName: 'qlrac:contracts_1', displayName: 'Điểm thu gom đã xác thực không cập nhật', defaultVisible: true, zIndex: 750, popupFields: {
        'ma_kh': 'Mã khách hàng',
        ...
        { id: 'wmsDiemthugom2Layer', wmsName: 'qlrac:contracts_2', displayName: 'Điểm thu gom đã xác thực có cập nhật', defaultVisible: true, zIndex: 750, popupFields: {
        'ma_kh': 'Mã khách hàng',
        'khach_hang': 'Tên khách hàng',
        'cua_hang_cong_ty': 'Cửa hàng/Công ty',
        'address': 'Địa chỉ đầy đủ',
